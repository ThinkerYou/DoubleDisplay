...
public class PresentationActivity extends Activity
    ...
    private static final int[] PHOTOS = new int[]{
            ...
            R.drawable.ic_launcher_round, R.drawable.ic_launcher, R.drawable.ic_launcher_round,
            R.drawable.ic_launcher_round, R.drawable.ic_launcher, R.drawable.ic_launcher_round,
            R.drawable.ic_launcher,
    };
    ...
    private void showPresentation(Display display, PresentationContents contents) {
        ...
        DemoPresentation presentation = new DemoPresentation(this, displays[1], contents);
    ...
    private final DisplayManager.DisplayListener mDisplayListener =
            new DisplayManager.DisplayListener() {
                ...
                public void onDisplayAdded(int displayId) {
                    Log.d("PresentationActivitDemo", "Display #" + displayId + " added.");
                    mDisplayListAdapter.updateContents();
                }

                @Override
                public void onDisplayChanged(int displayId) {
                    Log.d("PresentationActivitDemo", "Display #" + displayId + " changed.");
                    mDisplayListAdapter.updateContents();
                }

                @Override
                public void onDisplayRemoved(int displayId) {
                    Log.d("PresentationActivitDemo", "Display #" + displayId + " removed.");
                    mDisplayListAdapter.updateContents();
                }
            };
